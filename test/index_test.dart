...
void main() {
  group('Index test', () {
    test('Single Key sort - ascending', () {
      ...
      final list = index.performSnapshot();
      expect(list, equals(expectedOrder));
    });

    test('Single Key sort - descending', () {
    ...
    test('Single Key sort - deletion and reinsert', () {
      final index = Index([("id", true)]);
    ...
    test('Multiple insert with same index value', () {
      final index = Index([("a", true), ("b", false)]);
    ...
    test('Index on DateTime - ascending', () {
